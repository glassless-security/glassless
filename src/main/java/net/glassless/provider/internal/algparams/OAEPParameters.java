...
public class OAEPParameters extends AlgorithmParametersSpi {
   ...
   private byte[] digestNameToOID(String name) {
      return switch (name) {
         ...
         case "SHA-384", "SHA384" ->
            new byte[]{0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x02};
         case "SHA-512", "SHA512" ->
            new byte[]{0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x03};
         case "SHA-224", "SHA224" ->
            new byte[]{0x06, 0x09, 0x60, (byte) 0x86, 0x48, 0x01, 0x65, 0x03, 0x04, 0x02, 0x04};
