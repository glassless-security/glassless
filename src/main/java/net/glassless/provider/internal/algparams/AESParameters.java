...
/**
 * AlgorithmParameters implementation for AES.
 * Supports IvParameterSpec for the initialization vector.
 */
public class AESParameters extends AlgorithmParametersSpi {
    ...
    protected String engineToString() {
        if (iv != null) {
            return "AES Parameters: IV length=" + iv.length + " bytes";
        }
        return "AES Parameters: <not initialized>";
    }
}
