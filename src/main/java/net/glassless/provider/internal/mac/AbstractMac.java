...
public abstract class AbstractMac extends MacSpi {
   ...
   /**
    * Extracts the key bytes from the given key. Subclasses can override to
    * perform key derivation (e.g., PBKDF2 for PBE MACs).
    */
   ...
   protected void engineInit(Key key, AlgorithmParameterSpec params)
      ...
      keyBytes = extractKeyBytes(key, params);
   ...
   protected void engineReset() {
      if (evpMacCtx != null && keyBytes != null) {
         try {
            ...
            var _ = OpenSSLCrypto.EVP_MAC_init(evpMacCtx, keySegment, keyBytes.length, paramsSegment);
         } catch (Throwable e) {
            // Ignore reset errors
         }
      }
