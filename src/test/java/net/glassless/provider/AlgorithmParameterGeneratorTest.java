...
public class AlgorithmParameterGeneratorTest {
   ...
   class DSATests {
      ...
      void testGenerateDSAParametersDefault() throws Exception {
         AlgorithmParameterGenerator gen = AlgorithmParameterGenerator.getInstance("DSA", PROVIDER_NAME);
         assertNotNull(gen);
   ...
   class DHTests {
      ...
      void testGenerateDHParametersDefault() throws Exception {
         AlgorithmParameterGenerator gen = AlgorithmParameterGenerator.getInstance("DH", PROVIDER_NAME);
         assertNotNull(gen);
      ...
      void testDiffieHellmanAlias() throws Exception {
         AlgorithmParameterGenerator gen = AlgorithmParameterGenerator.getInstance("DiffieHellman", PROVIDER_NAME);
         assertNotNull(gen);
