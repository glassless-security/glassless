...
public class KeyGeneratorTest {
    ...
    class DESedeKeyGeneratorTests {
        ...
        void testDESedeKeyGeneration() throws Exception {
            KeyGenerator keyGen = KeyGenerator.getInstance("DESede", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(keyGen);
        ...
        void testTripleDESAlias() throws Exception {
            KeyGenerator keyGen = KeyGenerator.getInstance("TripleDES", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(keyGen);
    ...
    class HmacSHAKeyGeneratorTests {
        ...
        void testHmacSHAKeyGeneration(String algorithm, int expectedKeyLength) throws Exception {
            ...
            KeyGenerator keyGen = KeyGenerator.getInstance(keyGenAlgorithm, GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(keyGen);
        ...
        void testHmacSHA256CustomKeySize() throws Exception {
            KeyGenerator keyGen = KeyGenerator.getInstance("HmacSHA256", GlaSSLessProvider.PROVIDER_NAME);
