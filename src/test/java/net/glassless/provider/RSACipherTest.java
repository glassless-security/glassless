...
public class RSACipherTest {
   ...
   class RSAPKCS1PaddingTests {
      ...
      void testRSAPKCS1Padding(int keySize, int plaintextSize) throws Exception {
         ...
         Cipher decryptCipher = Cipher.getInstance("RSA/ECB/PKCS1Padding", PROVIDER_NAME);
      ...
      void testRSAAlias() throws Exception {
         ...
         Cipher decryptCipher = Cipher.getInstance("RSA", PROVIDER_NAME);
   ...
   class RSANoPaddingTests {
      ...
      void testRSANoPadding() throws Exception {
         Cipher cipher = Cipher.getInstance("RSA/ECB/NoPadding", PROVIDER_NAME);
         ...
         // Decrypt with private key
         Cipher decryptCipher = Cipher.getInstance("RSA/ECB/NoPadding", PROVIDER_NAME);
         decryptCipher.init(Cipher.DECRYPT_MODE, keyPair2048.getPrivate());
         byte[] decryptedBytes = decryptCipher.doFinal(encryptedBytes);
