...
public class XDHTest {
    ...
    class X25519KeyPairGeneratorTests {
        ...
        void testGenerateKeyPair() throws Exception {
            KeyPairGenerator kpg = KeyPairGenerator.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testGenerateKeyPairWithParam() throws Exception {
            KeyPairGenerator kpg = KeyPairGenerator.getInstance("XDH", GlaSSLessProvider.PROVIDER_NAME);
    ...
    class X448KeyPairGeneratorTests {
        ...
        void testGenerateKeyPair() throws Exception {
            KeyPairGenerator kpg = KeyPairGenerator.getInstance("X448", GlaSSLessProvider.PROVIDER_NAME);
            KeyPair kp = kpg.generateKeyPair();
    ...
    class X25519KeyAgreementTests {
        ...
        void testKeyAgreement() throws Exception {
            ...
            KeyAgreement ka1 = KeyAgreement.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
            ka1.init(kp1.getPrivate());
            ka1.doPhase(kp2.getPublic(), true);
            byte[] secret1 = ka1.generateSecret();

            // Party 2 derives shared secret
            KeyAgreement ka2 = KeyAgreement.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testXDHKeyAgreement() throws Exception {
            ...
            KeyAgreement ka1 = KeyAgreement.getInstance("XDH", GlaSSLessProvider.PROVIDER_NAME);
            ka1.init(kp1.getPrivate());
            ka1.doPhase(kp2.getPublic(), true);
            byte[] secret1 = ka1.generateSecret();

            KeyAgreement ka2 = KeyAgreement.getInstance("XDH", GlaSSLessProvider.PROVIDER_NAME);
            ka2.init(kp2.getPrivate());
            ka2.doPhase(kp1.getPublic(), true);
            byte[] secret2 = ka2.generateSecret();
        ...
        void testGenerateSecretKey() throws Exception {
            ...
            KeyAgreement ka = KeyAgreement.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
    ...
    class X448KeyAgreementTests {
        ...
        void testKeyAgreement() throws Exception {
            ...
            KeyAgreement ka1 = KeyAgreement.getInstance("X448", GlaSSLessProvider.PROVIDER_NAME);
            ka1.init(kp1.getPrivate());
            ka1.doPhase(kp2.getPublic(), true);
            byte[] secret1 = ka1.generateSecret();

            KeyAgreement ka2 = KeyAgreement.getInstance("X448", GlaSSLessProvider.PROVIDER_NAME);
            ka2.init(kp2.getPrivate());
            ka2.doPhase(kp1.getPublic(), true);
            byte[] secret2 = ka2.generateSecret();
    ...
    class XDHKeyFactoryTests {
        ...
        void testReconstructX25519Keys() throws Exception {
            ...
            KeyFactory kf = KeyFactory.getInstance("XDH", GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testTranslateKeys() throws Exception {
            ...
            KeyPairGenerator kpg2 = KeyPairGenerator.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
    ...
    class CrossProviderTests {
        ...
        void testCrossProviderKeyAgreement() throws Exception {
            // Generate key pairs
            KeyPairGenerator glasslessKpg = KeyPairGenerator.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
            ...
            KeyAgreement glasslessKa = KeyAgreement.getInstance("X25519", GlaSSLessProvider.PROVIDER_NAME);
