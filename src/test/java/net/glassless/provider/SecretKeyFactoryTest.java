...
public class SecretKeyFactoryTest {
    ...
    class PBKDF2Tests {
        ...
        void testPBKDF2KeyDerivation(String hashAlgorithm, int expectedKeyLength) throws Exception {
            ...
            SecretKeyFactory factory = SecretKeyFactory.getInstance(algorithm, GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testPBKDF2Consistency() throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA256", GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testEncodingDifference() throws Exception {
            SecretKeyFactory utf8Factory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA256", GlaSSLessProvider.PROVIDER_NAME);
            SecretKeyFactory eightBitFactory = SecretKeyFactory.getInstance("PBKDF2WithHmacSHA256And8BIT", GlaSSLessProvider.PROVIDER_NAME);
        ...
        void testPBKDF2KeyForEncryption() throws Exception {
            ...
            Cipher cipher = Cipher.getInstance("AES_256/CBC/PKCS5Padding", GlaSSLessProvider.PROVIDER_NAME);
    ...
    class PBETests {
        ...
        void testPBEKeyGeneration() throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("PBE", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(factory);
    ...
    class DESedeTests {
        ...
        void testDESedeFromKeySpec() throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("DESede", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(factory);
        ...
        void testTripleDESAlias() throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("TripleDES", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(factory);
    ...
    class PBES2Tests {
        ...
        void testPBES2Consistency() throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("PBEWithHmacSHA256AndAES_256", GlaSSLessProvider.PROVIDER_NAME);
    ...
    class AESTests {
        ...
        void testAESFromSecretKeySpec(int keyLength) throws Exception {
            SecretKeyFactory factory = SecretKeyFactory.getInstance("AES", GlaSSLessProvider.PROVIDER_NAME);
            assertNotNull(factory);
